...
public class FileEx {
    public static void main(String[] args) throws IOException {
        ...
        File folder = new File("C:\\Users\\777AMR\\Desktop\\A");

        File file2 = new File("C:\\Users\\777AMR\\Desktop\\A\\test1.txt");
        File folder2 = new File("C:\\Users\\777AMR\\Desktop\\B");
        ...
        System.out.println("file2.exists(): " + file2.createNewFile());
        System.out.println("folder2.exists(): " + folder2.mkdir());
        System.out.println("file2.exists(): " + file.createNewFile());
        System.out.println("-----------------------------------------------------");
